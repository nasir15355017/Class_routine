            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="{{route('course.add')}}">Courses All</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                            ...
                            <div class="card-body row">
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="txtFirstName" name="course_title" >
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="text" id="txtLasttName" name="course_code">
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="text" id="designation" name="credit">
                                        <label class="mdl-textfield__label">Cradit</label>
                                    </div>
                                </div>
                                <div class="col-lg-6 p-t-20">
                                    <div
                                            class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="text" id="designation" name="type">
