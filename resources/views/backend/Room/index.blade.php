            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="{{route('room.add')}}">Room Add</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{route('room.add')}}" id="addRow"
                                                               class="btn btn-info">
                                                    ...
                                                    <table
                                                        ...
                                                        <tr class="odd gradeX">
                                                            @foreach($rooms as $room)
                                                                <td class="left">{{$room->id}}</td>
                                                                <td class="left">{{$room->room_num}}</td>
                                                                <td class="left">{{$room->type}}</td>
