            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li><a class="parent-item" href="{{route('room.index')}}">Room All</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                            ...
                            <div class="card-body row">
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="designation" name="room_num">
