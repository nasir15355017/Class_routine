        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Day List</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                                                               href="{{route('main')}}">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                        <li><a class="parent-item" href="{{route('day.add')}}">Day</a>&nbsp;<i class="fa fa-angle-right"></i>
                        </li>
                        <li class="active">Day List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        <tr class="odd gradeX">
                                                            @foreach($days as $day)
                                                                <td class="left">{{$day->id}}</td>
                                                                <td class="left">{{$day->day_name}}</td>
