                            ...
                            <div class="card-body row">
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="txtFirstName" name="section" >
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="list11" value="" readonly
                                               tabIndex="-1" name="course_id" >
                                        <label for="list11" class="pull-right margin-0">
                                            <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                                        </label>
                                        <label for="list11" class="mdl-textfield__label" >Course</label>
                                        <ul data-mdl-for="list11" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                                            <li class="mdl-menu__item" data-val="DE">Course</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="example" value="" readonly
                                               tabIndex="-1" name="teacher_id" >
                                        <label for="example" class="pull-right margin-0">
                                            <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                                        </label>
                                        <label for="example" class="mdl-textfield__label" >Teacher</label>
                                        <ul data-mdl-for="example" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                                            <li class="mdl-menu__item" data-val="DE">Teacher1</li>
                                            <li class="mdl-menu__item" data-val="DE">Teacher2</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6 p-t-20">
                                    <div
                                        ...
                                        <input class="mdl-textfield__input" type="text" id="examplee" value="" readonly
                                               tabIndex="-1" name="semester_id" >
                                        <label for="examplee" class="pull-right margin-0">
                                            <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                                        </label>
                                        <label for="examplee" class="mdl-textfield__label" >Semester</label>
                                        <ul data-mdl-for="examplee" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                                            <li class="mdl-menu__item" data-val="DE">Semester1</li>
                                            <li class="mdl-menu__item" data-val="DE">Semester2</li>
                                        </ul>
                                    </div>
                                </div>
