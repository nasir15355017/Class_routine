...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jul 2019 14:10:01 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown language-switch">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img
                                    src="{{asset('backend/assets/img/flags/gb.png')}}" class="position-left" alt=""> English <span
                                    class="fa fa-angle-down"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="deutsch"><img src="{{asset('backend/assets/img/flags/de.png')}}" alt=""> Deutsch</a>
                            </li>
                            <li>
                                <a class="ukrainian"><img src="{{asset('backend/assets/img/flags/ua.png')}}" alt=""> Українська</a>
                            </li>
                            <li>
                                <a class="english"><img src="{{asset('backend/assets/img/flags/gb.png')}}" alt=""> English</a>
                            </li>
                            <li>
                                <a class="espana"><img src="{{asset('backend/assets/img/flags/es.png')}}" alt=""> España</a>
                            </li>
                            <li>
                                <a class="russian"><img src="{{asset('backend/assets/img/flags/ru.png')}}" alt=""> Русский</a>
                            </li>
                        </ul>
                    </li>
                    <!-- end language menu -->
                            ...
                            <li>
                                <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="{{asset('backend/assets/img/prof/prof2.jpg')}}" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="{{asset('backend/assets/img/prof/prof3.jpg')}}" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="{{asset('backend/assets/img/prof/prof1.jpg')}}" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="{{asset('backend/assets/img/prof/prof8.jpg')}}" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="{{asset('backend/assets/img/prof/prof5.jpg')}}" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                        ...
                        <li class="sidebar-user-panel">
                            <div class="user-panel">
                                <div class="pull-left image">
                                    <img src="{{asset('backend/assets/img/dp.jpg')}}" class="img-circle user-img-circle"
                                         alt="User Image" />
                                </div>
...
{{--                        </li>--}}
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('professor.index')}}" class="nav-link "> <span class="title">All
												Professors</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('professor.add')}}" class="nav-link "> <span class="title">Add
												Professor</span>
                                    </a>
                                </li>
{{--                                <li class="nav-item">--}}
...
{{--                                </li>--}}
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('course.index')}}" class="nav-link "> <span class="title">All
												Courses</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('course.add')}}" class="nav-link "> <span class="title">Add
												Course</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('room.index')}}" class="nav-link "> <span class="title">All Room
												</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('room.add')}}" class="nav-link "> <span class="title">Add Room
												</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('day.index')}}" class="nav-link "> <span class="title">All
												Day</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('day.add')}}" class="nav-link "> <span class="title">Add
												Day</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link nav-toggle"> <i class="material-icons">monetization_on</i>
                                <span class="title">Time Slot</span> <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{route('time.index')}}" class="nav-link "> <span class="title">Time
												Collection</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('time.add')}}" class="nav-link "> <span class="title">Add Time </span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link nav-toggle"> <i class="material-icons">school</i>
                                <span class="title">Slot Room</span> <span class="arrow"></span>
                                <span class="label label-rouded label-menu label-success">new</span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('section.add')}}" class="nav-link "> <span class="title">Add Section</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link nav-toggle"><i class="material-icons">group</i>
                                <span class="title">Day & Time</span><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="" class="nav-link "> <span class="title">
												Day and Time Collection</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('daytime.add')}}" class="nav-link "> <span class="title">Add
												Day and Time</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('slotroom.add')}}" class="nav-link "> <span class="title">Add
												 Slot Room</span>
                                    </a>
                                </li>
    ...
    <script src="{{asset('backend/assets/plugins/chart-js/utils.js')}}"></script>
...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Jul 2019 14:12:07 GMT -->
</html>
